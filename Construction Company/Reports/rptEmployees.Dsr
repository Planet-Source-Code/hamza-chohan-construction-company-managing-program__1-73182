VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptEmployees 
   Bindings        =   "rptEmployees.dsx":0000
   Caption         =   "Data Report"
   ClientHeight    =   5880
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   9060
   Icon            =   "rptEmployees.dsx":001E
   MDIChild        =   -1  'True
   ...
   EndProperty
End
Attribute VB_Name = "rptEmployees"
