...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment 
   ...
   _ExtentY        =   17436
   FolderFlags     =   1
   TypeLibGuid     =   "{67FB14A6-CE3F-4FBE-A263-08471A815AD4}"
   TypeInfoGuid    =   "{78FC17B6-9681-4BC1-92BE-53B659DCE180}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Database\Data.mdb;Persist Security Info=False"
      Expanded        =   -1  'True
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
